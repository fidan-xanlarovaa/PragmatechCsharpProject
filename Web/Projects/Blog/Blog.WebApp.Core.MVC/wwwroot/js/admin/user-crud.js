        ...
        if ($form.valid()) {
            $.ajax({
                ...
                data: new FormData(form), /*
                                           * eslinde biz datani Form.Seriliaze sekilinde de gondere bilerik.
                                           * Lakin eger burda File ile baqli emeliyyatlar varsa (sekilin yuklenmesi) onde serialize 
                                           * istifade etmek olmur. Mutleq FormData istifade olunmalidir.
                                           */
                contentType: false,
                processData: false,
